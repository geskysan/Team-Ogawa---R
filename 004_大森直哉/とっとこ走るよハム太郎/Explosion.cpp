...
void MakeVertexExplosion(LPDIRECT3DDEVICE9 pDevice)
{
	...
	for (nCutVtx = 0; nCutVtx < 128; nCutVtx++) {
		...
		pVtx[0].tex = D3DXVECTOR2(g_aExplosion[nCutVtx].nPatternAnim / MAX_ANIM, 1);
		pVtx[1].tex = D3DXVECTOR2(g_aExplosion[nCutVtx].nPatternAnim / MAX_ANIM, 0);
		pVtx[2].tex = D3DXVECTOR2(g_aExplosion[nCutVtx].nPatternAnim / MAX_ANIM+1.f / MAX_ANIM, 1);
		pVtx[3].tex = D3DXVECTOR2(g_aExplosion[nCutVtx].nPatternAnim / MAX_ANIM + 1.f / MAX_ANIM, 0);
		pVtx += 4;
